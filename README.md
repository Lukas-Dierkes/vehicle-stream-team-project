...
***
 ...
 2. Data Cleaning
    ...
    | ***clean_addresses(df, df_stops)*** | Checks if the addresses match those of the MoD Stop table and exports a list with the addresses that do not match. **Note**: Since June we receive new ride data and there is one new MoDStop called 'Wohnstift (Ersatz)' that is not listed in the list of MoDStops. |
